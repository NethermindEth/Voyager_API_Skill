...
# Voyager Dev Skill Installer for Claude Code
# Usage: ./install.sh [--project | --path <path>]

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SKILL_NAME="voyager-dev"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --path)
            ...
            ;;
        -h|--help)
            echo "Voyager Dev Skill Installer"
            echo ""
...
# Install skill
echo "Installing Voyager Dev Skill..."
...
echo ""
echo "The Voyager Dev Skill is now available in Claude Code."
echo "Try asking about Voyager API integration to activate it!"